<template>
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <label for="message" class="form-label">Вихідне повідомлення:</label>
            <textarea class="form-control" v-model.trim="message" id="messsage" rows="10"></textarea>
        </div>
    </div>
    <div class="row d-flex justify-content-center">
        <button @click="breakCipher" class="break-btn w-50">Виконати атаку</button>
    </div>
</template>
...
export default {
    ...
    methods:{
        breakCipher(){
            this.message = breakCaesarCipher(this.cipher, this.language, false);
        }
    }
}
